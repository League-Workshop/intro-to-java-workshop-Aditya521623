...
public class ScaryMaze extends JPanel implements Runnable, MouseMotionListener {
	...
	public void mouseMoved(MouseEvent e) {
		...
		if(mouseColor == -769226) {
			JOptionPane.showMessageDialog(null, " You won! Yay!");
		}
	...
	private void scare() {
		...
		AudioClip sound = JApplet.newAudioClip(getClass().getResource("noise.wav"));
